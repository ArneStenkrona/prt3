...
void main() {
    ...
    if (weightSum > 0.0) {
        boneTransform  = u_Bones[0] * a_BoneWeights[0];
        boneTransform += u_Bones[1] * a_BoneWeights[1];
        boneTransform += u_Bones[2] * a_BoneWeights[2];
        boneTransform += u_Bones[3] * a_BoneWeights[3];
    }
