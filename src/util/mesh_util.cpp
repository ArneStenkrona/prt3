...
void prt3::push_back_box(
    glm::vec3 const & lower_bound,
    glm::vec3 const & upper_bound,
    std::vector<glm::vec3> & buffer
) {
    size_t start_ind = buffer.size();
    buffer.resize(start_ind + 36);

    glm::vec3 * geo = &buffer[start_ind];

    // side 0
    geo[0]  = glm::vec3{ lower_bound.x, lower_bound.y, lower_bound.z };
    geo[1]  = glm::vec3{ upper_bound.x, lower_bound.y, lower_bound.z };
    geo[2]  = glm::vec3{ upper_bound.x, upper_bound.y, lower_bound.z };
    ...
    geo[10] = glm::vec3{ lower_bound.x, lower_bound.y, upper_bound.z };
    geo[11] = glm::vec3{ upper_bound.x, lower_bound.y, upper_bound.z };

    // side 2
    geo[12] = glm::vec3{ lower_bound.x, lower_bound.y, lower_bound.z };
    geo[13] = glm::vec3{ lower_bound.x, upper_bound.y, lower_bound.z };
    geo[14] = glm::vec3{ lower_bound.x, upper_bound.y, upper_bound.z };
    ...
    geo[22] = glm::vec3{ upper_bound.x, lower_bound.y, upper_bound.z };
    geo[23] = glm::vec3{ lower_bound.x, lower_bound.y, upper_bound.z };

    // side 4
    geo[24] = glm::vec3{ upper_bound.x, upper_bound.y, upper_bound.z };
    geo[25] = glm::vec3{ lower_bound.x, upper_bound.y, upper_bound.z };
    geo[26] = glm::vec3{ lower_bound.x, upper_bound.y, lower_bound.z };
    ...
    geo[34] = glm::vec3{ upper_bound.x, upper_bound.y, lower_bound.z };
    geo[35] = glm::vec3{ upper_bound.x, lower_bound.y, lower_bound.z };
}